...
Write-Host "==> 6/7 Copying secrets (.env + coach-guidelines.md, chmod 600)..." -ForegroundColor Cyan
scp ".\.env" "${Pi}:${RemoteDir}/.env"
ssh $Pi "chmod 600 ${RemoteDir}/.env"
if (Test-Path ".\coach-guidelines.md") {
  scp ".\coach-guidelines.md" "${Pi}:${RemoteDir}/coach-guidelines.md"
}
